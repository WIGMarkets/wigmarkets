...
export default function Calculator({ type = "compound", title = "Kalkulator inwestycyjny", theme }) {
  ...
  const result = useMemo(() => {
    const r = rate / 100;
    const n = years;
    // Future value with initial capital
    ...
    <div style={{
      ...
      <div style={{ display: "grid", gridTemplateColumns: "repeat(3, 1fr)", gap: 12 }}>
        {[
          ...
          <div key={label} style={{ background: theme.bgCard, borderRadius: 10, padding: "14px 16px", textAlign: "center", border: `1px solid ${theme.border}` }}>
