    ...
    <div style={{ color: theme.text, fontFamily: "var(--font-ui)" }}>
      <div style={{ maxWidth: 900, margin: "0 auto", padding: isMobile ? "16px 14px" : "28px 32px" }}>
        <div style={{ marginBottom: 20 }}>
          <h1 style={{ fontSize: isMobile ? 22 : 28, fontWeight: 800, color: theme.textBright, margin: "0 0 4px" }}>Portfolio</h1>
          <p style={{ fontSize: 13, color: theme.textSecondary, margin: 0 }}>Śledź swoje pozycje w czasie rzeczywistym</p>
        </div>
