...
export const GPW_COMPANIES = [
  ...
  { ticker: "ENG", stooq: "eng", name: "Energa SA", sector: "Energetyka", index: "WIG" },
  ...
  { ticker: "LVC", stooq: "lvc", name: "LiveChat Software", sector: "Technologia", index: "WIG" },
  { ticker: "MAB", stooq: "mab", name: "Mabion SA", sector: "Biotechnologia", index: "WIG" },
  { ticker: "MBG", stooq: "mbg", name: "MBank Group", sector: "Banki", index: "WIG" },
  ...
  { ticker: "URS", stooq: "urs", name: "Ursus SA", sector: "Przemysł", index: "WIG" },
  ...
  { ticker: "SGN", stooq: "sgn", name: "Selvita (old ticker)", sector: "Biotechnologia", index: "WIG" },
  ...
  { ticker: "GNB", stooq: "gnb", name: "Getin Holding SA", sector: "Finanse", index: "WIG" },
  ...
  { ticker: "PBG", stooq: "pbg", name: "PBG SA", sector: "Budownictwo", index: "WIG" },
